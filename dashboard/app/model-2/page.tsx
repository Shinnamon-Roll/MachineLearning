  ...
  if (!metrics && !history) {
      return (
        ...
        <header className="mb-10 text-center relative">
            ...
            <p className="text-muted-foreground mt-2">MobileNetV2 with Transfer Learning (Binary Classification)</p>
        </header>
        ...
        <section className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-6">
            ...
            <div className="max-w-md space-y-2">
                <h2 className="text-2xl font-bold">Model Not Trained Yet</h2>
            ...
            <Card className="w-full max-w-lg mt-8 bg-card border-2 border-dashed border-muted-foreground/50 shadow-none">
                <CardHeader>
                    <CardTitle className="text-lg">Architecture Details</CardTitle>
                </CardHeader>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-3 mt-8">
                ...
                <div className="border border-primary p-2 bg-card inline-block">
                    ...
                    <img src="/data/confusion_matrix_model2.png" alt="Confusion Matrix" className="max-w-full h-auto dark:invert" style={{ maxHeight: '400px' }} />
                </div>
